...
import { ITranslationsDatabaseService, TRANSLATIONS_DATABASE_SERVICE } from 'src/types/translations-database-service.interface';
...
export class TranslationsService implements ITranslationsService {
  constructor(
    @Inject(TRANSLATIONS_DATABASE_SERVICE) private readonly service: ITranslationsDatabaseService,
  ) {
  }
